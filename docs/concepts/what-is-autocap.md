...
Under the current [Filecoin Plus (FIL+)](https://fil.org/filecoin-plus) model, DataCap (DC) is typically allocated through a **permission-first process**.
...
Autocap is a **round-based DC allocation system** that rewards participants proportionally to their contribution to the Filecoin network, measured by **FIL burned through the settlement of Filecoin Pay rails**.
